...
<section>
  {#if googleFormUrl === undefined}
    <span class="intro">
      ...
      <p>
        Got any questions for us? Want to collaborate? Just want to say hi? Whatever it is, feel free to 
        contact us!  Send us an email by filling out the form below, and we’ll have a representative get 
